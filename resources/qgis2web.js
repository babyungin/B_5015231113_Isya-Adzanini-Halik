...
map.getView().fit([12549369.529621, -810992.308377, 12552502.186564, -809024.951759], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">WebGIS Jangkauan Halte Kecamatan Genteng</h2>';
        return titleElement;
    })(),
